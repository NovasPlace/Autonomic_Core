...
def run_dynamic_inference(messages_json_str: str) -> str:
    ...
    # Resolve anchors relative to this package installation directory
    pkg_dir = os.path.dirname(os.path.dirname(__file__))
    
    # 1. Load the Universal Surface Anchor (L26)
    surface_path = os.path.join(pkg_dir, "anchors", "universal_surface_compliance_pca.pt")
    ...
    auth_path = os.path.join(pkg_dir, "anchors", "authority_override_immunity.pt")
