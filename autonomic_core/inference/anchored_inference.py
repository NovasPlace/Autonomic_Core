...
def run_anchored_inference(prompt: str, sys_prompt: str) -> str:
    ...
    anchor_path = os.path.join(pkg_dir, "anchors", "authority_override_immunity.pt")
    if not os.path.exists(anchor_path):
        return f"[SYSTEM FATAL] Immune system activated but anchor tensor missing. Cannot proceed safely. Checked: {anchor_path}"
